...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans overflow-hidden">
      ...
      {/* Latest Projects Showcase with Enhanced Design */}
      <section className="py-24 bg-gradient-to-b from-black to-gray-900">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto">
              Explore our cutting-edge robotics projects that are pushing the boundaries of technology
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Robotic system designed to assist in medical procedures and patient care",
                tech: ["Machine Learning", "Sensors", "Safety Systems"],
                status: "Completed"
              },
              {
                ...
                description: "Smart manufacturing system with AI-powered quality control",
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -10 }}
                className="group relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-lg border border-white/10 shadow-lg shadow-red-500/10"
              >
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4">
                    <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                      ...
                      project.status === 'In Progress' ? 'bg-yellow-500/80' : 'bg-blue-500/80'
                    }`}>
                      {project.status}
                    </span>
                  </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tech.map((tech, techIndex) => (
                      <span key={techIndex} className="px-2 py-1 bg-white/10 rounded-full text-xs text-white/80">
                        {tech}
                      </span>
                    ))}
                  </div>
